        ...
        @else
            <div class="space-y-2">
                @foreach ($campaign->posts as $post)
                    <a href="{{ route('posts.edit', [$client, $post]) }}" class="flex items-center gap-3 p-3 rounded-sm border border-gray-100 hover:border-primary/30 hover:bg-primary/5 transition-all">
