<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="name" class="block w-full px-4 py-2.5 rounded-none border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all text-sm placeholder-gray-400 bg-gray-50/50" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Ex: João da Silva" />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input id="password" class="block w-full px-4 py-2.5 rounded-none border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all text-sm placeholder-gray-400 bg-gray-50/50" type="password" name="password" required autocomplete="new-password" placeholder="Mínimo 8 carac." />
            ...
            <div>
                ...
                <input id="password_confirmation" class="block w-full px-4 py-2.5 rounded-none border border-gray-200 focus:border-primary focus:ring-1 focus:ring-primary focus:outline-none transition-all text-sm placeholder-gray-400 bg-gray-50/50" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Repita a senha" />
