...
{{-- Client context bar — sticky below navbar, green bg, rounded bottom --}}
            ...
            <div class="flex items-center justify-between h-12 gap-6">
                ...
                <div class="flex items-center gap-3 flex-shrink-0">
                    <a href="{{ route('clients.index') }}"
                       class="flex items-center justify-center w-7 h-7 rounded-lg text-primary-foreground/50 hover:text-primary-foreground hover:bg-primary/15 transition-all duration-200">
                    ...
                    <div class="flex items-center gap-2.5">
                        <div class="inline-flex h-7 w-7 items-center justify-center rounded-lg bg-primary/30 text-primary-foreground font-bold text-[11px] ring-1 ring-primary/20">
                ...
                <nav class="flex items-center gap-1 -mb-px overflow-x-auto">
                    @php
                        $tabs = [
                            ...
                            ['route' => 'clients.campaigns', 'icon' => 'campaign', 'label' => 'Campanhas', 'match' => request()->routeIs('clients.campaigns')],
                            ['route' => 'clients.insights', 'icon' => 'insights', 'label' => 'Insights', 'match' => request()->routeIs('clients.insights')],
