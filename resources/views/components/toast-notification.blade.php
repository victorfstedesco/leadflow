...
<div x-data="{ show: true }"
    ...
    <div class="bg-white rounded-none border border-gray-100 shadow-[0_8px_30px_-4px_rgba(0,0,0,0.12)] px-5 py-4 flex items-start gap-4">
        {{-- Icon --}}
        ...
        <button @click="show = false"
                class="w-7 h-7 rounded-none hover:bg-gray-100 flex items-center justify-center flex-shrink-0 transition-colors -mt-0.5 -mr-1">
